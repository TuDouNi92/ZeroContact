...
import net.zerocontact.api.caliber.ICartridgeType;
...
public enum CaliberHelper {
    ...
    CALIBER_556x45(
            new Caliber("tacz:556x45", 1, 2, 5, 4, .10f)
    ),
    CALIBER_580x42(
            new Caliber("tacz:58x42", 1, 3, 6, 6f, .14f)
    ),
    CALIBER_308(
            new Caliber("tacz:308", 1, 4, 10, 8, .27f)
    ),
    CALIBER_50AE(
            new Caliber("tacz:50ae", 1, 2, 9, 6.2f, .2f)
    ),
    CALIBER_9mm(
            new Caliber("tacz:9mm", 1, 1.5f, 4, 3.75f, 1f)
    ),
    CALIBER_45ACP(
            new Caliber("tacz:45acp", 1, 1.25f, 5, 4, .09f)
    ),
    CALIBER_762x25(
            new Caliber("tacz:762x25", 1, 1.5f, 3, 3f, .06f)
    ),
    CALIBER_762x54(
            new Caliber("tacz:762x54", 1, 4, 12, 8, .33f)
    ),
    CALIBER_338(
            new Caliber("tacz:338", 1, 3, 14, 15, .6f)
    ),
    CALIBER_68x51(
            new Caliber("tacz:68x51fury", 1, 2.5f, 7, 6, .21f)
    ),
    CALIBER_50BMG(
            new Caliber("tacz:50bmg", 1, 4, 18, 18.5f, 1)
    ),
    CALIBER_12G(
            new Caliber("tacz:12g", 10, 0.2f, 3, 1.25f, .03f)
    ),
    CALIBER_22WMR(
            new Caliber("tacz:22wmr", 1, 1.5f, 5, 6, .33f)
    ),
    CALIBER_30_06(
            new Caliber("tacz:30_06", 1, 4, 8, 12, .25f)
    ),
    CALIBER_46x30(
            new Caliber("tacz:46x30", 1, 2f, 4, 5, .21f)
    ),
    CALIBER_57x28(
            new Caliber("tacz:57x28", 1, 1.5f, 5, 6, .31f)
    ),
    CALIBER_45_70(
            new Caliber("tacz:45_70", 1, 5f, 8, 10, .22f)
    ),
    CALIBER_357MAG(
            new Caliber("tacz:357mag", 1, 2, 6, 7, .12f)
    ),
    CALIBER_500MAG(
            new Caliber("tacz:500mag", 1, 3, 7, 6, .24f)
    );
    ...
    public record Caliber(
        ...
        //
        public Caliber(String id, int bulletAmount, float baseDamageFactor, int penetrationClass, float fleshDamage, float armorDamage) {
            this(
                    id,
                    DEFAULT,
                    30,
