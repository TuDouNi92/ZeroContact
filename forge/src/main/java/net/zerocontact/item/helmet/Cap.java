...
public class Cap extends BaseGeoHelmet {
    private Cap(int absorb, int defaultDurability, ResourceLocation texture, ResourceLocation model, ResourceLocation animation, float bluntReduction, float penetrateReduction) {
    ...
    public enum Color {
        ...
        Color(ColorResources resources) {
            this.resources = resources;
        }
    }

    public static Cap create(int absorb, int durability, Color color, float bluntReduction, float penetrateReduction) {
        return new Cap(absorb, durability, color.resources.texture, color.resources.model, color.resources.animation, bluntReduction, penetrateReduction);
    }
}
