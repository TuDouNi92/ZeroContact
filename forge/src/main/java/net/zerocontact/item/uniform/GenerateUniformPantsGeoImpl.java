...
public class GenerateUniformPantsGeoImpl extends AbstractGenerateGeoCurioItemImpl implements IEquipmentTypeTag, IItemLoader.GeneratableItem {
    ...
    public void deserializeItems() {
        ...
        for (ItemGenData data0 : itemGenDataList) {
            ...
            if (!(data.equipmentSlot).equals(EquipmentType.UNIFORM_PANTS.getTypeId())) continue;
