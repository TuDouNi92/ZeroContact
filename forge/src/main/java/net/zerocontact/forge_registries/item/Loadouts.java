...
public class Loadouts implements TabableItem {
    ...
    public static RegistrySupplier<BaseBackpack> R6SH118_EMR = ItemsReg.ITEMS.register("backpack_6sh118", () -> Backpack.create(Backpack.Series.R6SH118, 42));
